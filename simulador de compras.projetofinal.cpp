...
int main(){
	...
	//Tabela com os produtos, códigos e os preços
	...
	printf("-------------------------------------------------\n\n\n");
	//printf para receber a quantidade de produtos
	printf("Quantos produtos deseja comprar? ");
	scanf("%i", &i);
	//Laço para receber o código do produto e passar pelo escolha para informar o valor que o cliente deverar pagar no final 
	while(c <= i){
	printf("==================================\n");
